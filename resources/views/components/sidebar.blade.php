    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('respond') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('respond') }}"><i class="fas fa-person" style="color: black;"></i>
                    <span>Respon Permintaan </span></a>
            </li>
            ...
            <li class="{{ Request::is('adminugas') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('adminugas') }}"><i class="fas fa-screwdriver-wrench"></i> <span>Servis
                        Berlangsung
                    </span></a>
            </li>
