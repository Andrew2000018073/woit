                        ...
                        <div class="form-group">
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item col-5.5">
                                    <input type="radio" name="kategori" value="internal" class="selectgroup-input" onclick="enablepriority()">
                                    <span class="selectgroup-button">Internal</span>
                                </label>
                                <div class="col-1"></div>
                                <label class="selectgroup-item col-5.5">
                                    <input type="radio" name="kategori" value="external" class="selectgroup-input" onclick="disablepriority()">
                            ...
                            <div class="form-group">
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="priority" value="rendah" class="selectgroup-input" id="rendah" required>
                                        <span class="selectgroup-button selectgroup-button-icon" id="btnrendah">Rendah (1 hingga 4 Minggu)</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="priority" value="sedang" class="selectgroup-input" id="sedang" required>
                                        <span class="selectgroup-button selectgroup-button-icon" id="btnsedang">Sedang (2 hingga 7 hari) </span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="priority" value="tinggi" class="selectgroup-input" id="tinggi" required>
                                        <span class="selectgroup-button selectgroup-button-icon" id="btntinggi">Tinggi (Kurang dari 24 jam) </span>
                                    </label>
                                </div>
                ...
                <div class="row  ">
                    <div class="card col-12 gap-3">
                        ...
                        <div class="form-group">
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="status" value="selesai" class="selectgroup-input" onclick="enable()">
                                    <span class="selectgroup-button selectgroup-button-icon"><i class="fa-regular fa-circle-check"> </i> Tandai Selesai</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="status" value="diambil" class="selectgroup-input" onclick="disable()">
                                    <span class="selectgroup-button selectgroup-button-icon"><i class="fa-solid fa-screwdriver-wrench"></i> Tandai Sebagai Diambil</span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" name="waktuambil" class="form-control datetimepicker" disabled id="waktuambil">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Waktu Selesai</label>
                                        <input type="text" class="form-control datetimepicker" disabled id="waktuselesai">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group  ">
