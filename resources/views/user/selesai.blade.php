    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body h-100 mb-5">
                <div class="row">
                    <div class="col-7">
                        <div class="card card-success h-100% mb-5">
                                            ...
                                            <div class="activity">
                                                ...
                                                <div class="activity-detail">
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="bullet"></span>
                                                        <span class="text-job">{{ $data->waktu_selesai }}</span>
                                                    </div>
                                                    <p>
                                                        {{ $data->admin->nama }} Selesai mengerjakan perbaikan kepada
                                                        perbaikan
                                                        dengan nomor komplain
                                                        {{ $data->nomor_komplain }}
                                                    </p>
